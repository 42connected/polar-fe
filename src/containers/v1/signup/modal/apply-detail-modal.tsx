...
import { Info } from '@/containers/v1/signup/modal/info/info';
import {
  ApplyDetailModalProps,
  IRows,
  MentorsData,
} from '@/containers/v1/signup/modal/mentor-details-modal-inteface';
import { ModalFooter } from '@/containers/v1/signup/modal/modal-footer';
import { Time } from '@/containers/v1/signup/modal/time/time';
