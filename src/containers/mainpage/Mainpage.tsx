...
import img from '../../assets/logo/phone.png';
import icon1 from '../../assets/keywordIcon/employment.png';
import icon2 from '../../assets/keywordIcon/startups.png';
import icon3 from '../../assets/keywordIcon/cooperation.png';
import icon4 from '../../assets/keywordIcon/plan.png';
import icon5 from '../../assets/keywordIcon/develop.png';
import icon6 from '../../assets/keywordIcon/skill.png';
import icon7 from '../../assets/keywordIcon/cs.png';
import icon8 from '../../assets/keywordIcon/field.png';
import { keywordsPro } from './Getkeyword';
import { useEffect, useState } from 'react';
import { axiosInstance } from '../../context/axios-interface';

const MainpageStyle = styled.body`
  display: flex;
  flex-wrap: wrap;
  width: 100vw;
  height: 100vw;
...
`;
const MainImageStyle = styled.body`
  flex: 1;
  padding-left: 15rem;
  padding-top: 20rem;
`;
const TitleStyle = styled.body`
  text-decoration-line: underline;
`;
const IconImageStyle1 = styled.body`
  display: flex;
  flex-direction: row;
...
`;
const KeywordStyle = styled.body`
  display: flex;
  flex-direction: row;
