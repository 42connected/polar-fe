...
import { getReportId, reportsPro } from './getreportdata';
...
const SimpleComponent = (props: {
  ...
  return (
    <div ref={printRef}>
      {reportDatas?.map((reportdata: reportsPro, index: number) => {
        return (
  ...
  const getReports = async (reportId: string) => {
    try {
      ...
      const save = await axiosInstance.get(`/reports/${reportId}`, {
        headers: {
          Authorization: `bearer eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJ1c2VybmFtZSI6Im0tZW5nZW5nIiwicm9sZSI6ImJvY2FsIiwiaWF0IjoxNjYxOTI4ODk0LCJleHAiOjE2NjIwMTUyOTR9.PBBtkaFQt3bakkFro7zPMK_EWN40vJLjrt2po5r_SeE`,
        },
      });
